package com.marcobehler.part_05_xa.code;
...
public class BitronixJTADataSourceExercise {
    ...
    public static class MySpringConfig {
        @Bean(destroyMethod = "close", name = "dataSourceOne", initMethod = "init")
        ...
        @Bean(destroyMethod = "close", name = "dataSourceTwo", initMethod = "init")
...
// PlatformTransactionManager
        ...
        public PlatformTransactionManager jtaTransactionManager() {
            return new JtaTransactionManager(bitronixManager(), bitronixManager());
        }
